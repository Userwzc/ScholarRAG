...
class Qwen3VLEmbedder():
    ...
    def process(self, inputs: List[Dict[str, Any]], normalize: bool = True, batch_size: int = 4) -> torch.Tensor:
        all_embeddings = []
        ...
        for i in range(0, len(inputs), batch_size):
            ...
            batch_embeddings = self._pooling_last(outputs['last_hidden_state'], outputs['attention_mask'])
