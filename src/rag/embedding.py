...
class Qwen3VLEmbeddings:
    def __init__(
        self, model_name_or_path: str = "../models/Qwen3-VL-Embedding-2B", **kwargs
    ):
    ...
    def embed_image(
        self, image_path: str, text: str = None, instruction: str = None
    ) -> list[float]:
    ...
    def embed_images(
        self, image_paths: list[str], instruction: str = None
    ) -> list[list[float]]:
